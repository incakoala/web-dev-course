...
var JavaHighlightRules = function() {
    ...
    "const|float|native|super|while|Math.sin()|Math.cos()|Math.tan()|" +
    "Math.asin()|Math.acos()|Math.atan()|Math.atan2()|Math.cosh()|Math.sinh()|" +
    "Math.tanh()|Math.log1()|Math.log101()|Math.log1p()|Math.exp()|Math.expm1()|" +
    "Math.cbrt()|Math.sqrt()|Math.hypot()|Math.signum()|Math.signum1()|Math.ulp()|" +
    "Math.ulp1()|Math.abs()|Math.abs1()|Math.abs2()|Math.abs3()|Math.ceil1()|Math.floor1()|" +
    "Math.IEEERemainder()|Math.pow()|Math.rint()|Math.round()|Math.round1()|Math.todegrees()|" +
    "Math.toradians()|charAt()|compareTo()|compareToIgnoreCase()|concat()|contentEquals()|" +
    "copyValueOf()|endsWith()|equals()|equalsIgnoreCase()|getBytes()|getChars()|hashCode()|" +
    "indexOf()|intern()|lastIndexOf()|length()|matches()|regionMatches()|replace()|replaceAll()|" +
    "replaceFirst()|split()|startsWith()|subSequence()|substring()|toCharArray()|toLowerCase()|" +
    "toString()|toUppercase()|trim()|valueOf()|java.math.*|java.io.*"
    );
